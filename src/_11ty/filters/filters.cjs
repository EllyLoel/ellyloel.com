...
module.exports = (eleventyConfig) => {
	eleventyConfig.addFilter("addNonBreakingSpace", require("./addNonBreakingSpace.cjs"));
	...
	eleventyConfig.addFilter("dateToLocale", require("./dateToLocale.cjs"));
	...
	eleventyConfig.addFilter("getLatestCollectionItemDate", require("./getLatestCollectionItemDate.cjs"));
	...
	eleventyConfig.addFilter("removeRandomLink", require("./removeRandomLink.cjs"));
