...
<details>
	...
	<div class="[ flex gap-3 flex-col ]">
		{% image "./public/assets/img/flexbox-publication-history.png", "The flexbox spec went from draft to recommendation, then back to draft and back to recommendation again!" %}
		{% image "./public/assets/img/grid-publication-history.png", "The grid spec followed the usual draft to recommendation flow with no back tracking." %}
	</div>
</details>
...
![The history of flexbox. 2008, Birth of an idea, CSS Working Group first discussed the idea of Flexbox. 2009, Published Draft, CSS Working Group publishes first public draft. 2012, W3C Candidate Recommendation, Flexbox is stable and supported in browsers. 2014, Improvements, The Flexbox team started working on improvements. 2016, W3C Candidate Recommendation, Flexbox is updated and is stable and supported in browsers.](./public/assets/img/The-History-of-Flexbox.webp)
...
![Not the hero we deserved, but the hero we needed.](./public/assets/img/hero-we-needed.png)
...
![A grid of 6 semi transparent elements overlapping in different ways.](./public/assets/img/overlapping-elements.png)_OVERLAP ALL THE THINGS._
...
![2 grids, each with 3 columns containing cards. The first grid's cards content sections are misaligned while the second grid's cards are correctly aligned thanks to subgrid.](./public/assets/img/subgrid.png)_The contents of the cards are able to be aligned thanks to subgrid._
...
![5 elements laid out with flex, 4 and 5 are much wider than 1, 2, and 3.](./public/assets/img/1d-vs-2d-1.png)

Grid positions its elements based on both it's rows and columns.

![5 elements laid out with grid, all the elements are the same width.](./public/assets/img/1d-vs-2d-2.png)
...
![5 elements laid out with flex, 4 and 5 are much wider than 1, 2, and 3.](./public/assets/img/intrinsic-or-extrinsic-1.png)_Intended layout._

![The same 5 elements but now 1 and 2 have shrunk slightly and 3 has grown slightly due to it's content.](./public/assets/img/intrinsic-or-extrinsic-2.png)_Doesn't look like it's changed (it has)._

![The same 5 elements but now 1, 2, 3, and 4 are all the same size and 5 is twice their size.](./public/assets/img/intrinsic-or-extrinsic-3.png)_Woah, what the?!_

![The same 5 elements but now none of the elements are the same size, all because of 3's large content.](./public/assets/img/intrinsic-or-extrinsic-4.png)_Oh boy, what in the world is going on?!?_

#### Grid will stick to it's rows and columns no matter what, so it's layout first or extrinsic.

![5 elements laid out with grid, all the elements are the same width.](./public/assets/img/intrinsic-or-extrinsic-5.png)_Intended layout._

![The same 5 elements but now 2 and 5 are slightly wider because of 2's content.](./public/assets/img/intrinsic-or-extrinsic-6.png)_Doesn't look like it's changed (it has)._

![The same 5 elements but now 2 and 5 are wider because of 2's content.](./public/assets/img/intrinsic-or-extrinsic-7.png)_Never changing these columns._

![The same 5 elements but now 2 and 5 are a lot wider and 3 is overflowing because of 2's content.](./public/assets/img/intrinsic-or-extrinsic-8.png)_Uh oh, we've got some overflow._
...
![The same 5 elements, all the elements are the same width but 2's content is cut off.](./public/assets/img/intrinsic-or-extrinsic-9.png)_A very very long what?_
...
![](./public/assets/img/layout-mode-cheat-sheet.png)
